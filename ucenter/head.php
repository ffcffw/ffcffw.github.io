...
<script type="text/javascript">uaredirect("<?php echo $mkcms_domain;?>wap/user.php");</script>
		...
		<div class="container">			
			<div class="clearfix navbar-top">				
				...
				<a class="pull-right hidden-xs">					
					...
					<span class="telephone"><img src="<?php echo $mkcms_weixin;?>"></span>			
				</a>			
			...
			<div class="container">				
				<div class="navbar-header">					
					<ul class="nav navbar-left navbar-collapse collapse">						
						<li class=""><a href="<?php echo $mkcms_domain;?>" class="">首页 </a></li>						
					...
					<?php if($mkcms_qianxian==1){?><li><a href="<?php echo $mkcms_domain;?>vlist.php?cid=0">尝鲜</a></li><?php }?>
					<?php

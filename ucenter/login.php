...
<div id="wrapper" class="pad-bottom">
  ...
  <div class="login-main">
    <form class="form-horizontal js-ajax-form" method="post">
        ...
        <div class="controls">
          <input class="form-control input-lg span4" id="login_username" type="text" name="u_name" value="" required placeholder='用户名' />
		 ...
		 <div class="hy-layout hidden-xs" style="border-top: 2px solid #ff6428;">
	         <div class="hy-footer-link">
	             <div class="item clearfix">
	                 <p style="padding: 10px 4px 0 4px;text-align:center" class="container-fluid"><?php echo $mkcms_copyright;?><?php echo $mkcms_tongji;?></p>
				 </div>
			 </div>
	     </div>
</body>

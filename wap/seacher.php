...
$szz4='#<b>类型：</b>[\s\S]*?</li>#';
$szz5='#<b>地区：</b>[\s\S]*?</li>#';
$szz6='#<div class="m-score">(.*?)</div>#';//评分
$szz7='#<b>导演：</b>(.*?)</li>#';//导演
$szz8='#<div class="m-description">[\s\S]*?</div>#';//简介
...
preg_match_all($mxss,$seach,$sarr10);
...
?>
<li><a href="<?php echo $chuandi?><?php echo $html?>">
...
<p class="clearfix leimu"><span class="fl"></span><span class="fr"><?php echo get_channel_name($row['d_parent'])?></span></p>
        <a href="<?php echo $chuandi?><?php echo $html?>">

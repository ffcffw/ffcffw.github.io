...
<meta name="description" content="<?php echo $mkcms_description;?>">
	<meta name="keywords" content="<?php echo $mkcms_name;?>,<?php echo $mkcms_keywords;?>">
</head>
...
<body>
        ...
        <div class="container">
            <h1 class="ilogo"><a href="/" title="logo"><img src="<?php echo $mkcms_logo;?>" alt="<?php echo $mkcms_seoname;?>电视直播"><span><?php echo $mkcms_name;?>在线直播</span></a></h1>
            <nav class="sitenav">
			<a href="<?php echo $mkcms_domain;?>wap/">首页</a>
			<a href="<?=$mkcms_domain?>wap/movie.php">电影</a>
			<a href="<?=$mkcms_domain?>wap/tv.php">剧集</a>
			<a href="<?=$mkcms_domain?>wap/zongyi.php">综艺</a>
			<a href="<?=$mkcms_domain?>wap/dongman.php">动漫</a>
			<?php
						$result = mysql_query('select * from mkcms_nav');
        ...
        <div class="container izb">
            ...
            <div class="zb-con">
                ...
                <ul class="zb-list hide">
                    <li><a href="javascript:;" data-url="http://tv.bbbbbb.me/player.php?channel=hunantv"><b><img src="skin/images/hn.png" /></b><span>湖南卫视</span></a></li>

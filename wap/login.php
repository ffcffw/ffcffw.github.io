  ...
  <div class="login-form">
    <form action="" method="post" class="form-horizontal form">
        <div class="login-user-name common-div">
            ...
            <input type="text" name="u_name" value="" placeholder="请输入用户名" />        
          </div>
          <div class="login-user-pasw common-div">
            <span class="pasw-icon common-icon">
              <img src="<?php echo $mkcms_domain;?>wap/style/images/password.png" />
            </span>
             <input type="password" name="u_password" value="" placeholder="请输入密码" />        
          </div>
                ...
                <div class="weui_cells weui_cells_form">
                    <div class="weui_cell">
                        ...
                        <div class="weui_cell_bd weui_cell_primary">
                            <input class="weui_input" name="name" id="tel" type="number" required pattern="[0-9]{11}" maxlength="11" placeholder="作为登录账号使用" emptyTips="请输入账号">
                        </div>

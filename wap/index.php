...
echo '<div class="swiper-slide" style="height:220px;">  
            <a href="./play.php?play='.$cs.'" style="width:100%;height:0;padding-bottom: 100%;overflow:hidden;">
...
$ok="";
			...
			echo '<li><a '.$ok.' href="'.$ccb.''.$html.'"><img src="'.$row['d_picture'].'"></a>
        <p class="clearfix leimu"><span class="fl"></span><span class="fr">'.get_channel_name($row['d_parent']).'</span></p> 
        <a href="'.$ccb.''.$html.'"><span class="biaoti">'.$row['d_name'].'</span></a></li>';
...
<section class="tuijian_box">
  <h2 class="clearfix tuijian bgfff"><em class="dianshiju"></em>剧集推荐<a class="fr more" href="./tv.php">更多<em class="more_icon"></em></a></h2>
  <div class="dianying_box  bgfff clearfix">
    <ul class="clearfix">

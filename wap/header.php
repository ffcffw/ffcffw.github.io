<section class="logo_box clearfix">
  ...
  <div class="sosuo_box fl">
    <form  action="<?php echo $mkcms_domain;?>wap/seacher.php?wd=<?php echo $q?>" method="get" role="form">
    <input class="btn_com btn_sosuo" type="text" placeholder="请输入影视、剧集关键词、支持拼音" name="wd" value="">
    </form>
  </div>
...
<li><a href="<?php echo $mkcms_domain;?>wap/">首页</a></li>
					...
					<?php if($mkcms_dianshi==1){?><li <?php echo $tv;?>><a href="<?php echo $mkcms_domain;?>wap/tv.php">剧集</a></li><?php }?>
...
<section class="gonggao_box clearfix">
  <div class="gonggao_box2 clearfix"> <span class="gonggao fl">公告</span>
      <div id="gongao" class="fl xianshi" style="width: 82%;height: 27px"> 
        ...
        <div id="scroll_begin"> 
         <span href="" style="background: none;color: #000"><?php echo $mkcms_gonggao?></span>
        </div> 
        <div id="scroll_end">  
         <span href="" style="background: none;color: #000"><?php echo $mkcms_gonggao?></span>
        </div> 

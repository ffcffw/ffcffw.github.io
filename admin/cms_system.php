...
<div class="form-group">
									...
									<input id="s_logo" class="form-control" name="s_logo" type="text" size="40" value="'.$row['s_logo'].'" />
													...
													<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
													<label for="name-w1">首页/WAP弹窗公众号二维码</label>
													<?php echo'<div class="input-group">
									<input id="s_weixin" class="form-control" name="s_weixin" type="text" size="40" value="'.$row['s_weixin'].'" />
													...
													<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
													<label for="name-w1">WAP微信打赏二维码</label>
														<?php echo'<div class="input-group">
...
<div class="row">
							...
							<?php echo'<input id="s_mjk" class="form-control" name="s_mjk" type="text" size="60" value="'.$row['s_mjk'].'" />
										<span class="help-block">自动播放时的接口</span>';?>
													...
													<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
													<label for="name-w1">是否自动轮播</label><span class="help-block">开启后自动采集幻灯片</span>
												<?php 
echo'<div class="radio-custom radio-inline" style="float:left">
			...
			<label for="inline-radio32">关闭</label>
			</div>';
?></div>
												</div>
												<div class="row">
...
<?php echo'<textarea class="form-control" name="s_jiekou" style="height:200px;" />'.$row['s_jiekou'].'</textarea>
										<span class="help-block">多个解析请用“回车”分开，如：<br>米酷解析$https://micool.net/jk.php?url=<br>米酷解析$https://micool.net/jk.php?url=</span>';?>
														</div>
													</div>
												</div>
												<div class="row">
...
提交保存。</span>';?>
												...
												<div class="row">
													<div class="col-sm-12">
														<div class="form-group has-feedback">
															<label for="name-w1">WAP端微信关注提醒文字</label>

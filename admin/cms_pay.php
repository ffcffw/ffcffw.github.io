...
<option value="1" <?php echo ($row['s_alipay']=='1' ? 'selected="selected"':'');?>>乐迅易支付</option>
<option value="2" <?php echo ($row['s_alipay']=='2' ? 'selected="selected"':'');?>>QQ乐码支付</option>
...
<option value="5" <?php echo ($row['s_alipay']=='5' ? 'selected="selected"':'');?>>乐讯易支付</option>
<option value="6" <?php echo ($row['s_alipay']=='6' ? 'selected="selected"':'');?>>彩虹易支付</option>
<option value="7" <?php echo ($row['s_alipay']=='7' ? 'selected="selected"':'');?>>QQ乐支付</option>
<option value="8" <?php echo ($row['s_alipay']=='8' ? 'selected="selected"':'');?>>Hack易支付</option>
<option value="9" <?php echo ($row['s_alipay']=='9' ? 'selected="selected"':'');?>>宏伟云支付</option>
</select>

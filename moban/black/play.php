...
<li><a class="btn btn-sm btn-default" href="<?php echo $mkcms_domain;?>addfav.php?title=<?php echo $timu; ?>&dizhi=<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'].'?'.$_SERVER['QUERY_STRING'];?>"> <i class="icon iconfont icon-collection"></i> 收 藏</a></li>
</ul>
<span class="text-muted">正在为您播放-<?php echo $timu; ?><span class="js"></span></span>
</div>
...
echo'<span class="text-muted pull-right"><i class="icon iconfont icon-xiangyou"></i></span></a>
...
foreach ($zyvi as $keya=>$tvideoa){
	echo "<a data-num='$noqi[$keya]' href='$tvideoa'  style='width:48%;float:left' class='btn-play-source'><img src='$zypic[$keya]' width=100%/><br>$noqi[$keya]<br>$zyname[$keya]</a>";
    }
	echo '</div>
	</div>
</div></ul>

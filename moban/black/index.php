				...
				<div class="hy-index-menu clearfix">
					<div class="item">
						<ul class="clearfix">
							...
							<li><a href="./tv.php?m=/dianshi/list.php?cat=all&page=1"><i class="icon iconfont icon-tv_icon text-color"></i><span>剧集</span></a></li>
...
<div class="row"  style="margin-top:10px"><?php echo get_ad(3)?></div></div>
		<div class="hy-layout clearfix">
			<div class="hy-video-head">
				...
				<ul class="pull-right">
				<?php
$result = mysql_query('select * from mkcms_vod_class where c_pid=0 order by c_id asc LIMIT 0,10');
while ($row = mysql_fetch_array($result)){

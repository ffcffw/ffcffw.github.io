...
echo "<a href='?m=$flid' class='acat' >$flname2</a>"; } 
?></dd>
      </dl>
      <dl class="cleafix">
...
if ($vcat == "易烊千玺"||$vcat == "王俊凯"||$vcat == "黄磊"||$vcat == "黄渤"||$vcat == "吴亦凡"||$vcat == "赵薇"||$vcat == "沈腾"||$vcat == "罗志祥"||$vcat == "张艺兴"||$vcat == "潘玮柏"||$vcat == "钱枫"||$vcat == "涂磊"||$vcat == "华晨宇") {
echo "";} else {

...
$dm='class="active"'?>
<title>动漫列表-2018最新好看的最新电影-<?php echo $mkcms_seoname;?></title>
...
<h3 class="title"><img src="<?php echo $mkcms_domain;?>moban/<?php echo $mkcms_bdyun;?>/img/icon_25.png">动漫频道</h3></div>
</div>
</div>
<div class="stui-pannel stui-pannel-bg clearfix"> 
...
<dt>按剧情</dt> 
  <dd><a href="?m=/dongman/list.php?cat=all&page=1" >全部</a></dd>
<?php
foreach($dmcat as $kcat=>$vcat){$flname=$dmname[$kcat];
$flid='/dongman/list.php?cat='.$vcat.'&page=1';
echo "<dd><a href='?m=$flid' target='_self'>$flname</a></dd>";}?></dl>  
      <dl class="fed-col-sx12 fed-col-sm6 fed-col-md4"> 
        <dt>按年份</dt>
<dd><a href="?m=/dongman/list.php?year=all&pageno=1">全部</a></dd>
<?php
foreach($dmcat1 as $kcat=>$vcat){$flname=$dmname1[$kcat];
$vcat2 = str_replace(array("\r","\n"),"",$vcat);
$flid='/dongman/list.php?year='.$vcat2.'&page=1';
echo "<dd><a href='?m=$flid' target='_self'>$flname</a></dd>";}?>
      </dl>
     <dl class="fed-col-sx12 fed-col-sm6 fed-col-md4"> 
        <dt>按地区</dt>
        <dd><a href="?m=/dongman/list.php?area=all&page=1">全部</a></dd>
<?php
...
?>
<li <?php if ($ye=="rankhot"){echo 'class="active"';}elseif($ye=="createtime" or $ye=="rankpoint"){}else{ echo 'class="active"';};?>><a href="?m=/dongman/list.php?rank=rankhot&page=1">最近热映</a></li>
					<li <?php if ($ye=="createtime"){echo 'class="active"';}else{};?>><a href="?m=/dongman/list.php?rank=createtime&page=1">最近更新</a></li>
				</ul>
</div>
</div>

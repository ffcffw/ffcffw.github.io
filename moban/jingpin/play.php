...
【<span style="color:red">播放提示</span>】：<label>如果无法播放请点此<a href="###" style="color:red" onclick="openShutManager(this,box)">&nbsp;切换线路&nbsp;</a></label>
</div>
...
<h4 class="title">正在播放：<?php echo $timu; ?><span class="js"></span></h4>
<p class="data margin-0 ">
<span class="text-muted hidden-xs ">地区：</span><?php echo $h; ?>
<span class="split-line"></span><span class="text-muted hidden-xs ">年份：</span><?php echo $g; ?>
...
foreach ($zyvi as $keya=>$tvideoa){
		...
		echo "<li class='zyli'><a data-num='$noqi[$keya]' href='$tvideoa' class='btn btn-danger btn-play-source 1'><img src='$zypic[$keya]' width=100%/><br>$noqi[$keya]<br>$zyname[$keya]</a></li>";
		}
		echo '</ul>
</div>';
						}

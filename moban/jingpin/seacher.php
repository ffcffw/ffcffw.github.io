...
?>
		 <li class ="activeclearfix">
          <div class="thumb">
           <a class="v-thumb stui-vodlist__thumb lazyload" href="<?php echo $chuandi?><?php echo $html?>" title="<?php echo $cs?>" data-original="<?php echo $tupian?>"><span class="play hidden-xs"></span>
		   <span class="pic-text text-right"></span></a>
          </div>
		  <div class="detail">
           <h3 class="title"><a href="<?php echo $chuandi?><?php echo $html?>"><?php echo $cs?></a><span class="playtype"><?php echo get_channel_name($row['d_parent'])?></span></h3>
           <p class="margin-0 hidden-smss hidden-xss"><span class="text-muted">简介：</span></p> <p class="margin-0 hidden-smss hidden-xss"><?php echo $jianjie?></p>
		   <p class="margin-0 hidden-smss hidden-xss"><a class="text-muted" href="<?php echo $chuandi?><?php echo $html?>">查看详情</a></p>
          </div>
         </li>
<?php } ?> 	
<?php 
		 ...
		 <li class ="activeclearfix" <?php echo $xianshi?>>
		  ...
		  <div class="detail">
           <h3 class="title"><a href="<?php echo $chuandi?>"><?php echo $cs?></a></h3><br>
            <p class="margin-0 hidden-smss hidden-xss"><?php echo $jianjie?></p>

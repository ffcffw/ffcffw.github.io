...
$tv='class="active"'?>
<title>追热剧-最新剧集-好看剧集-最新剧集排行-<?php echo $mkcms_seoname;?></title>
...
<h3 class="title"><img src="<?php echo $mkcms_domain;?>moban/<?php echo $mkcms_bdyun;?>/img/icon_25.png">剧集频道</h3></div>
</div>
</div>
<div class="stui-pannel stui-pannel-bg clearfix"> 

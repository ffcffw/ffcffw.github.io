...
var stui = {
	...
	mobile: {
		...
		slide: function() {
			$.getScript("https://cdnjs.cloudflare.com/ajax/libs/flickity/2.0.10/flickity.pkgd.min.js", function() {
	...
	images: {
		lazyload: function() {
			$.getScript("https://cdnjs.cloudflare.com/ajax/libs/jquery_lazyload/1.9.7/jquery.lazyload.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 200,
					failurelimit: 15,
	...
	common: {
		bootstrap: function() {
			$.getScript("https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/js/bootstrap.min.js", function() {
		...
		headroom: function() {
			$.getScript("https://cdnjs.cloudflare.com/ajax/libs/headroom/0.9.4/headroom.min.js", function() {
				$("#header-top", function() {

...
?>
				<div class="hy-video-details active clearfix">
					<div class="item clearfix">
						<dl class="content">
							<dt><a class="videopic" href="<?php echo $chuandi?><?php echo $html?>" style="background: url(<?php echo $tupian?>) no-repeat; background-position:50% 50%; background-size: cover;"><span class="play hidden-xs"></span></a></dt>
							<dd class="clearfix">
							<div class="head">
								<h3><?php echo $cs?></h3>
							</div>
...
<li><span class="text-muted">简介：</span><?php echo $jianjie?></li>
							...
							<div class="block">
								<a class="text-muted" href="<?php echo $chuandi?><?php echo $html?>">查看详情 <i class="icon iconfont icon-xiangyou"></i></a>
							</div>
							</dd>
						</dl>
					</div>
...
<div class="hy-video-details active clearfix" <?php echo $xianshi?>>
					<div class="item clearfix">
						<dl class="content">
							...
							<dd class="clearfix">
							<div class="head">
								<h3><?php echo $cs?><?php echo $three[$ni]?><?php echo $si[$ni]?></h3>
							</div>
							<div class="score">
								<div class="star">
							...
							<ul><li><?php echo $jianjie?></li></ul>
							<div class="block">
								<a class="text-muted" href="<?php echo $chuandi?>">查看详情 <i class="icon iconfont icon-xiangyou"></i></a>
							</div>
							</dd>
						</dl>
					</div>
	...
	<div class="col-md-3 col-sm-12 hy-main-side hidden-sm hidden-xs">
			<div class="hy-layout clearfix">
				<div class="hy-video-ranking side clearfix">
					<div class="head">
						<a class="text-muted pull-right" href="<?php echo $mkcms_domain;?>movie.php?m=/dianying/list.php?cat=all%26pageno=1">更多 <i class="icon iconfont icon-xiangyou"></i></a>
				...
				<div class="hy-video-ranking side clearfix">
					<div class="head">
						<a class="text-muted pull-right" href="<?php echo $mkcms_domain;?>tv.php?u=/dianshi/list.php?cat=all%26pageno=1">更多 <i class="icon iconfont icon-xiangyou"></i></a>
						<h4><i class="icon iconfont icon-top text-color"></i> 剧集排行榜</h4>
					</div>
					<div class="item">
						<ul class="clearfix">
						<?php 

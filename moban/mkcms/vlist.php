...
$ok="";
			...
			echo '<div class="col-md-2 col-sm-3 col-xs-4">
							<a class="videopic lazy" '.$ok.' href="'.$ccb.''.$html.'" title="'.$row['d_name'].'" data-original="'.$row['d_picture'].'" style="background: url(./style/load.gif) no-repeat; background-position:50% 50%; background-size: cover;"><span class="play hidden-xs"></span></a>
							<div class="title">
			...
			<div class="hy-page clearfix">
				<ul class="cleafix"><div monitor-desc='分页' id='js-ew-page' data-block='js-ew-page'  class='ew-page'>
<?php echo page_show1($pager[2],$pager[3],$pager[4],2);?></div></ul>
			</div>		</div>
	</div>
</div>
